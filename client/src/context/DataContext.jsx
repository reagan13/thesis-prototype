...
export const DataProvider = ({ children }) => {
	...
	const [isSidebarCollapsed, setIsSidebarCollapsed] = useState(false); // Add this line
	...
	const sortedChatHistory = Array.isArray(data.chatHistory)
		? [...data.chatHistory].sort((a, b) => b.id - a.id)
		: [];
	...
	return (
		<DataContext.Provider
			value={{
				...
				isSidebarCollapsed, // Add this line
				setIsSidebarCollapsed, // Add this line
			}}
		>
			{children}
		</DataContext.Provider>
