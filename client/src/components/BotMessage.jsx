...
const BotMessage = ({
  ...
  intent,
  ner,
  // CHANGE: Removed classified_input from props destructuring
  weightedSum,
  modelUsed,
  id,
  isSelected,
    ...
    <div className={`flex items-end ${isSelected ? "bg-gray-100" : ""}`}>
      ...
      <div className="flex flex-col max-w-[700px]">
        ...
        >
          ...
          {/* CHANGE: Removed classified_input display */}
          <div className="flex justify-between items-center pt-4 gap-10">
            ...
            <button
              ...
              className="font-semibold py-2 px-4 rounded-full bg-black text-white hover:border-black hover:border hover:bg-white hover:text-black transition:transition-all duration-200 ease-in-out"
            >
              Chat Analysis {">"}
            </button>
          </div>
...
BotMessage.propTypes = {
  ...
  // CHANGE: Removed classified_input from propTypes
