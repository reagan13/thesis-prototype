          ...
          <div key={`message-${index}`} className="space-y-4">
            ...
            <div className="flex justify-start">
              <BotMessage
                ...
                timestamp={message.botResponse.timestamp}
                category={message.botResponse.category}
                intent={message.botResponse.intent}
                ner={message.botResponse.ner || []}
                classified_input={message.botResponse.classified_input} // CHANGE: Added
